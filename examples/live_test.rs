...
use yanki::{AnkiClient, NoteBuilder, StoreMediaParams};
...
async fn main() -> yanki::Result<()> {
    ...
    let note = NoteBuilder::new(TEST_DECK, "Basic")
        .field("Front", "Test question from yanki-rs")
    ...
    let test_media = StoreMediaParams::from_base64(
        "_yanki_rs_test.txt",
        "SGVsbG8gZnJvbSBhbmtpLWNvbm5lY3QtcnMh", // "Hello from yanki-rs!"
    );
    ...
    let actions = vec![
        ...
        yanki::actions::MultiAction::new("version"),
    ];
